...
async function createCollectionNft(
  ...
  console.log(
      `Collection Mint-koleksiyon: https://explorer.solana.com/address/${nft.address.toString()}?cluster=devnet`
  )
...
export async function nftMethod(nftData: any,method: any) {
